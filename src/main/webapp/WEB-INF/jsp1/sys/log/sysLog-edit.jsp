...
<form class="layui-form" action="#">
	<input name="" value="${sysLog.}" type="hidden">
	<div class="layui-row">
		...
		<div class="layui-col-xs12">
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button class="layui-btn" lay-submit lay-filter="sysLog_edit">确定修改</button>
...
<script>
	...
	layui.use(['form','common'], function() {
		...
		form.on('submit(sysLog_add)', function(data) {
			common.ajaxTableData("${server}sys/log/doEdit?${_csrf.parameterName}=${_csrf.token}",data.field);
			return false;
		});
		form.render();
	});
