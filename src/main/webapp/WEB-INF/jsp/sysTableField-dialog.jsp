...
<script type="text/javascript">
	...
	$('#sysTableFieldDialog_aceAdd').on('click',function() {
		aceAdd("添加表字段","${server}toAdd?${_csrf.parameterName}=${_csrf.token}","${server}doAdd?${_csrf.parameterName}=${_csrf.token}","sysTableField_add_form","sysTableFieldDialog");
	});
	//修改
	function aceEditf(id) {
		aceEdit(id,"修改表字段","${server}toEdit?${_csrf.parameterName}=${_csrf.token}","${server}doEdit?${_csrf.parameterName}=${_csrf.token}","sysTableField_edit_form","sysTableFieldDialog");
	}
	//查看
	...
	//删除
	function aceDelF(id) {
		aceDel(id , 'sysTableFieldDialog',"${server}del?${_csrf.parameterName}=${_csrf.token}");
	}
	...
	$('.page-content-area').ace_ajax('loadScripts',[],function() {
		...
		initMainTable("sysTableFieldDialog","${server}search?${_csrf.parameterName}=${_csrf.token}",columnsDialog);
