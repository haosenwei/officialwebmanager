...
<script type="text/javascript">
	...
	$('#sysMenuDialog_aceAdd').on('click',function() {
		aceAdd("添加菜单表","${server}sys/sysmenutoAdd?${_csrf.parameterName}=${_csrf.token}","${server}sys/sysmenudoAdd?${_csrf.parameterName}=${_csrf.token}","sysMenu_add_form","sysMenuDialog");
	});
	//修改
	function aceEditf(id) {
		aceEdit(id,"修改菜单表","${server}sys/sysmenutoEdit?${_csrf.parameterName}=${_csrf.token}","${server}sys/sysmenudoEdit?${_csrf.parameterName}=${_csrf.token}","sysMenu_edit_form","sysMenuDialog");
	}
	//查看
	...
	//删除
	function aceDelF(id) {
		aceDel(id , 'sysMenuDialog',"${server}sys/sysmenudel?${_csrf.parameterName}=${_csrf.token}");
	}
	...
	$('.page-content-area').ace_ajax('loadScripts',[],function() {
		...
		initMainTable("sysMenuDialog","${server}sys/sysmenusearch?${_csrf.parameterName}=${_csrf.token}",columnsDialog);
