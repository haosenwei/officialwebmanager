...
<form class="layui-form" action="#">
	<div class="layui-row">
		...
		<div class="layui-col-xs12">
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button class="layui-btn" lay-submit lay-filter="sysConfig_add">立即提交</button>
...
<script>
	...
	layui.use(['form','common'], function() {
		...
		form.on('submit(sysConfig_add)', function(data) {
			common.ajaxTableData("${server}sys/config/doAdd?${_csrf.parameterName}=${_csrf.token}",data.field);
			return false;
		});
		form.render();
	});
