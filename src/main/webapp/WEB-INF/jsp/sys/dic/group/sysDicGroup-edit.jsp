...
<form class="layui-form" action="#">
	<input name="" value="${sysDicGroup.}" type="hidden">
	<div class="layui-row">
		...
		<div class="layui-col-xs12">
			<div class="layui-form-item">
				<div class="layui-input-block">
					<button class="layui-btn" lay-submit lay-filter="sysDicGroup_edit">确定修改</button>
...
<script>
	...
	layui.use(['form','common'], function() {
		...
		form.on('submit(sysDicGroup_add)', function(data) {
			common.ajaxTableData("${server}sys/dic/group/doEdit?${_csrf.parameterName}=${_csrf.token}",data.field);
			return false;
		});
		form.render();
	});
